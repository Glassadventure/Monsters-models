...
firesignal(game.ReplicatedStorage.Bricks.Caption.OnClientEvent, "It seems you got into a horror Mode...")
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"You died to...", "Stop you died to Smiler?", "How he not Added in the game"}, -- Custom death message
})
...
Achievements.Get({
    Title = "Stop rebound",
    Desc = "Secret entity...",
    Reason = "Encounter and not survive the rare entity called Smiler",
...
Achievements.Get({
   Title = "Rebounds...",
    Desc = "Secret entity",
    Reason = "Encounter and survive the rare Entity called Smiler",
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"You died to a-60", "t glows Bright red and emits a distinctive sound", "Its so rare Entity"}
})
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"You died to Voidi", "It doesn't glow but it makes a loud sound", "It looks Like A Void..."}
})
...
Achievements.Get({
    Title = "Void...",
    Desc = "Empty both outside and inside",
    Reason = "Encounter and survive The rare entity called Voidi",
